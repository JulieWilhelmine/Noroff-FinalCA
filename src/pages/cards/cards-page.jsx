...
export default class CardsPage extends React.Component {
    ...
    handleSearchTerm(searchTerm) {
        const app = this;
        let cardObj = app.state.magicObj;

        let cards = cardObj.filter((card) => {
            return card.name.indexOf(searchTerm) !== -1;
        });
    ...
    render() {
        ...
        console.log('app.state.cardArray', app.state.cardArray)
